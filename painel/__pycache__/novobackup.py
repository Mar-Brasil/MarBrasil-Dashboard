...
<div class="semestral-card">
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
        ...
        <div style="text-align: center; flex: 1;">
            <div style="font-size: 0.9em;" class="adaptive-text">⚠️ Faltam Prev. Semestral</div>
...
<div class="corretiva-card">
    <div class="card-title">
        <span>📝</span>
        <span>PMOC – Levantamento</span>
    </div>
    <hr style="margin: 15px 0; border-color: rgba(52, 152, 219, 0.2);">
    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
        <div style="text-align: center; flex: 1;">
            <div style="font-size: 0.9em;" class="adaptive-text">✅ PMOC Realizadas</div>
            <div style="font-size: 1.5em; font-weight: bold;" class="adaptive-text">{pmoc_finalizadas}</div>
        </div>
        <div style="text-align: center; flex: 1;">
            <div style="font-size: 0.9em;" class="adaptive-text">⏸️ PMOC em Pausa</div>
            <div style="font-size: 1.5em; font-weight: bold;" class="adaptive-text">{pmoc_pausadas}</div>
        </div>
        <div style="text-align: center; flex: 1;">
            <div style="font-size: 0.9em;" class="adaptive-text">🕒 PMOC Não Realizadas</div>
            <div style="font-size: 1.5em; font-weight: bold;" class="adaptive-text">{pmoc_abertas}</div>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
